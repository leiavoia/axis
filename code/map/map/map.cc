...
for (int counter = 0; counter < map_rows; counter++ ) {
	...
	for (int counterB = 0; counterB < map_cols; counterB++ ) {
		...
		else if ( the_map[counterB][counter].obst == 5 ) {cout << 'R';}
		else if ( the_map[counterB][counter].obst == 6 ) {cout << 'O';}
		else if ( the_map[counterB][counter].obst == 7 ) {cout << 'Y';}
		else if ( the_map[counterB][counter].obst == 8 ) {cout << 'G';}
		else if ( the_map[counterB][counter].obst == 9 ) {cout << 'B';}
		else if ( the_map[counterB][counter].obst == 10) {cout << 'V';}
		else if ( the_map[counterB][counter].obst == 11) {cout << 'W';}
		else if ( the_map[counterB][counter].obst == 12) {cout << 'B';}
		}
	cout << "*\n";
	}
for (int counter = 0; counter < map_cols + 2; counter++) {cout << '*';}
